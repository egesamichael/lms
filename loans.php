			...
			<table class="table table-bordered" id="loan-list">
				...
				<tbody>
					<?php
						...
						$qry = $conn->query("SELECT l.*,concat(b.firstname,' ',b.lastname)as name, b.contact_no, b.email, b.address, b.aadhaar from loan_list l inner join borrowers b on b.id = l.borrower_id  order by id asc");
